    ...
    return (
        <div className="space-y-6">
            < div className ="bg-blue-600 text-white p-6 rounded-xl shadow-lg text-center">
                < p className ="text-blue-100 text-sm uppercase tracking-wider font-semibold">VeÃ­culos no PÃ¡tio</p>
    ...
    <button
        ...
        className="bg-orange-600 hover:bg-orange-700 text-white p-6 rounded-xl shadow flex flex-col items-center justify-center gap-2 transition-transform active:scale-95"
            ...
            <LogOut size={40} className="rotate-180" />
                < span className ="font-bold text-lg">SaÃ­da</span>
        </button >
      </div >

    <div className="bg-white p-4 rounded-lg shadow">
        < h3 className ="font-bold text-gray-700 mb-2">Acesso RÃ¡pido</h3>
            < p className ="text-sm text-gray-500">Use os botÃµes acima para registrar movimentaÃ§Ãµes.</p>
      </div >
    </div >
  )
}
