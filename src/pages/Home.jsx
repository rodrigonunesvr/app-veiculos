    ...
    return (
        <div className=\"space-y-6\">
            < div className =\"bg-blue-600 text-white p-6 rounded-xl shadow-lg text-center\">
                < p className =\"text-blue-100 text-sm uppercase tracking-wider font-semibold\">Veículos no Pátio</p>
...
className =\"bg-green-600 hover:bg-green-700 text-white p-6 rounded-xl shadow flex flex-col items-center justify-center gap-2 transition-transform active:scale-95\"
    ...
    <div className=\"bg-white p-4 rounded-lg shadow\">
        < h3 className =\"font-bold text-gray-700 mb-2\">Acesso Rápido</h3>
            < p className =\"text-sm text-gray-500\">Use os botões acima para registrar movimentações.</p>
      </div >
    </div >
  )
}
