...
export default function Exit() {
    ...
    const handleExit = async (event) => {
        if (!confirm(`Confirmar saÃ­da da placa ${event.plate}?`)) return
    ...
    return (
        <div className="max-w-md mx-auto">
            < h2 className ="text-xl font-bold mb-4 text-orange-700">Registrar SaÃ­da</h2>
    ...
    {
        filtered.length === 0 && <p className="text-center text-gray-500">Nenhum veÃ­culo encontrado.</p>}
        {
